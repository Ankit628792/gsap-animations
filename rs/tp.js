(() => {
  ...
  var _parsePosition = function _parsePosition2(animation, position, percentAnimation) {
    var labels2 = animation.labels, recent = animation._recent || _zeroPosition, clippedDuration = animation.duration() >= _bigNum ? recent.endTime(false) : animation._dur, i2, offset, isPercent;
  ...
  var _initTween = function _initTween2(tween, time, tTime) {
    var vars = tween.vars, ease = vars.ease, startAt = vars.startAt, immediateRender = vars.immediateRender, lazy = vars.lazy, onUpdate = vars.onUpdate, onUpdateParams = vars.onUpdateParams, callbackScope = vars.callbackScope, runBackwards = vars.runBackwards, yoyoEase = vars.yoyoEase, keyframes = vars.keyframes, autoRevert = vars.autoRevert, dur = tween._dur, prevStartAt = tween._startAt, targets = tween._targets, parent = tween.parent, fullTargets = parent && parent.data === "nested" ? parent.vars.targets : targets, autoOverwrite = tween._overwrite === "auto" && !_suppressOverwrites, tl3 = tween.timeline, cleanVars, i2, p, pt, target, hasPriority, gsData, harness, plugin, ptLookup, index, harnessVars, overwritten;
  ...
  var Tween = /* @__PURE__ */ function(_Animation2) {
    ...
    function Tween2(targets, vars, position, skipInherit) {
      ...
      var _this3$vars = _this3.vars, duration = _this3$vars.duration, delay = _this3$vars.delay, immediateRender = _this3$vars.immediateRender, stagger = _this3$vars.stagger, overwrite = _this3$vars.overwrite, keyframes = _this3$vars.keyframes, defaults3 = _this3$vars.defaults, scrollTrigger = _this3$vars.scrollTrigger, yoyoEase = _this3$vars.yoyoEase, parent = vars.parent || _globalTimeline, parsedTargets = (_isArray(targets) || _isTypedArray(targets) ? _isNumber(targets[0]) : "length" in vars) ? [targets] : toArray(targets), tl3, i2, copy, l, p, curTarget, staggerFunc, staggerVarsToMerge;
      ...
      if (keyframes || stagger || _isFuncOrString(duration) || _isFuncOrString(delay)) {
        ...
        if (stagger || _isFuncOrString(duration) || _isFuncOrString(delay)) {
          ...
          for (i2 = 0; i2 < l; i2++) {
            ...
            tl3.to(curTarget, copy, staggerFunc ? staggerFunc(i2, curTarget, parsedTargets) : 0);
  ...
  var _gsap = {
    ...
    registerEffect: function registerEffect(_ref3) {
      ...
      _effects[name] = function(targets, vars, tl3) {
        return effect(toArray(targets), _setDefaults(vars || {}, defaults3), tl3);
      };
      if (extendTimeline) {
  ...
  // node_modules/.pnpm/@unseenco+taxi@1.4.0/node_modules/@unseenco/taxi/src/helpers.js
  ...
  // node_modules/.pnpm/@unseenco+taxi@1.4.0/node_modules/@unseenco/taxi/src/Transition.js
  ...
  // node_modules/.pnpm/@unseenco+taxi@1.4.0/node_modules/@unseenco/taxi/src/Renderer.js
  var Renderer = class {
  ...
  // node_modules/.pnpm/@unseenco+taxi@1.4.0/node_modules/@unseenco/taxi/src/RouteStore.js
  ...
  // node_modules/.pnpm/@unseenco+taxi@1.4.0/node_modules/@unseenco/taxi/src/Core.js
  ...
  var _maxScroll = function _maxScroll2(element, _ref2) {
    ...
    return Math.max(0, (s2 = "scroll" + d2) && (a = _getProxyProp(element, s2)) ? a() - _getBoundsFunc(element)()[d] : _isViewport3(element) ? (_docEl2[s2] || _body2[s2]) - _getViewportDimension(d2) : element[s2] - element["offset" + d2]);
  };
  ...
  function convertToPath(element, swap) {
    var type = element.tagName.toLowerCase(), circ = 0.552284749831, data, x, y, r2, ry, path, rcirc, rycirc, points, w, h, x2, x3, x4, x5, x6, y2, y3, y4, y5, y6, attr;
  ...
  function arcToSegment(lastX, lastY, rx, ry, angle, largeArcFlag, sweepFlag, x, y) {
    ...
    angleStart %= TWOPI;
    angleExtent %= TWOPI;
    var segments = Math.ceil(_abs2(angleExtent) / (TWOPI / 4)), rawPath = [], angleIncrement = angleExtent / segments, controlLength = 4 / 3 * _sin2(angleIncrement / 2) / (1 + _cos2(angleIncrement / 2)), ma = cosAngle * rx, mb = sinAngle * rx, mc = sinAngle * -ry, md = cosAngle * ry, i2;
  ...
  // node_modules/.pnpm/@gsap+shockingly@3.12.2/node_modules/@gsap/shockingly/MorphSVGPlugin.js
  var gsap4;
  var _toArray2;
  ...
  var _getClosestAnchor = function _getClosestAnchor2(rawPath, x, y) {
    var j = rawPath.length, closestDistance = _bigNum3, closestX = 0, closestY = 0, segment, dx, dy, d, i2, l;
    while (--j > -1) {
      segment = rawPath[j];
      l = segment.length;
      for (i2 = 0; i2 < l; i2 += 6) {
  ...
  var _getClosestSegment = function _getClosestSegment2(bezier, pool, startIndex, sortRatio, offsetX, offsetY) {
    var l = pool.length, index = 0, minSize = Math.min(bezier.size || _getSize3(bezier), pool[startIndex].size || _getSize3(pool[startIndex])) * sortRatio, min = _bigNum3, cx = bezier.centerX + offsetX, cy = bezier.centerY + offsetY, size, i2, dx, dy, d;
  ...
  var _offsetPoints = function _offsetPoints2(text, offset) {
    ...
    var a = text.match(_numExp2) || [], l = a.length, s2 = "", inc, i2, j;
    if (offset === "reverse") {
      i2 = l - 1;
      inc = -2;
    } else {
  ...
  var MorphSVGPlugin = {
    ...
    init: function init4(target, value, tween, index, targets) {
      ...
      var type, p, pt, shape, isPoly, shapeIndex, map, startSmooth, endSmooth, start, end, i2, j, l, startSeg, endSeg, precompiled, sData, eData, originFactors, useRotation, offset;
  ...
  // node_modules/.pnpm/@gsap+shockingly@3.12.2/node_modules/@gsap/shockingly/utils/matrix.js
  var _doc6;
  var _win5;
  var _docElement2;
  var _body3;
  ...
  // node_modules/.pnpm/@gsap+shockingly@3.12.2/node_modules/@gsap/shockingly/Flip.js
  var _id = 1;
  var _toArray3;
  var gsap5;
  var _batch;
  ...
  var _recordProps = function _recordProps2(elState, props) {
    var getProp = gsap5.getProperty(elState.element, null, "native"), obj = elState.props = {}, i2 = props.length;
    while (i2--) {
  ...
  var _lockBodyScroll = function _lockBodyScroll2(lock) {
    if (lock !== _bodyLocked) {
      var s2 = _body4.style, w = _body4.clientWidth === window.outerWidth, h = _body4.clientHeight === window.outerHeight, i2 = 4;
      if (lock && (w || h)) {
        while (i2--) {
  ...
  var FlipState = /* @__PURE__ */ function() {
    ...
    _proto.interrupt = function interrupt(soft) {
      ...
      this.targets.forEach(function(t2) {
        var tl3 = t2._flip, foundInProgress = _killFlip(tl3, soft ? 0 : 1);
  ...
  var FlipBatch = /* @__PURE__ */ function() {
    ...
    _proto4.animate = function animate() {
      var _this4 = this;
      var prevBatch = _batch, tl3 = this.timeline, i2 = this.actions.length, finalStates, endTime;
      _batch = this;
      tl3.clear();
  ...
  var Flip = /* @__PURE__ */ function() {
    ...
    Flip2.killFlipsOf = function killFlipsOf(targets, complete) {
      (targets instanceof FlipState ? targets.targets : _toArray3(targets)).forEach(function(t2) {
  ...
  // node_modules/.pnpm/@gsap+shockingly@3.12.2/node_modules/@gsap/shockingly/DrawSVGPlugin.js
  var gsap6;
  var _toArray4;
  var _doc7;
  var _win6;
  ...
  var _getPosition = function _getPosition2(target, length) {
    ...
    var cs = _win6.getComputedStyle(target), dash = cs.strokeDasharray || "", offset = _parseNum(cs.strokeDashoffset), i2 = dash.indexOf(",");
  ...
  var _findMinimum = function _findMinimum2(values2) {
    var l = values2.length, min = _bigNum4, i2;
    for (i2 = 1; i2 < l; i2 += 6) {
  ...
  var _normalize = function _normalize2(values2, height, originY) {
    ...
    var tx = +values2[0] * -1, ty = -originY, l = values2.length, sx = 1 / (+values2[l - 2] + tx), sy = -height || (Math.abs(+values2[l - 1] - +values2[1]) < 0.01 * (+values2[l - 2] - +values2[0]) ? _findMinimum(values2) + ty : +values2[l - 1] + ty), i2;
    if (sy) {
      sy = 1 / sy;
    } else {
      sy = -sx;
  ...
  var CustomEase = /* @__PURE__ */ function() {
    ...
    _proto.setData = function setData(data, config3) {
      config3 = config3 || {};
      data = data || "0,0,1,1";
      var values2 = data.match(_numExp4), closest = 1, points = [], lookup = [], precision = config3.precision || 1, fast = precision <= 1, l, a1, a2, i2, inc, j, point, prevPoint, p;
      this.data = data;
      ...
      for (i2 = 2; i2 < l; i2 += 6) {
        ...
        points.push(a1, a2);
        _bezierToPoints(a1.x, a1.y, +values2[i2], +values2[i2 + 1], +values2[i2 + 2], +values2[i2 + 3], a2.x, a2.y, 1 / (precision * 2e5), points, points.length - 1);
      }
      l = points.length;
      for (i2 = 0; i2 < l; i2++) {
        point = points[i2];
    ...
    CustomEase2.getSVGData = function getSVGData(ease, config3) {
      config3 = config3 || {};
      var width = config3.width || 100, height = config3.height || 100, x = config3.x || 0, y = (config3.y || 0) + height, e2 = gsap7.utils.toArray(config3.path)[0], a, slope, i2, inc, tx, ty, precision, threshold, prevX, prevY;
      if (config3.invert) {
        height = -height;
        y = 0;
      }
